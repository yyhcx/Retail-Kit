  ...
  return (
    <div className="flex min-h-full flex-col bg-[#f5f8fc] font-sans text-slate-800">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden px-4 pb-0 pt-7 sm:px-6 sm:pt-8">
          ...
          <div className="relative mx-auto w-full max-w-7xl">
            <div className="mb-5 flex flex-col gap-3 border-b border-slate-200 pb-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/85 px-3.5 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-slate-600 shadow-sm sm:px-4 sm:tracking-[0.18em]">
